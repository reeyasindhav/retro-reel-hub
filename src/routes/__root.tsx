...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Retrowave — Classic & Vintage Cinema Archive" },
      {
        name: "description",
        content:
          "Retrowave is a curated archive of classic, cult and overlooked cinema. Browse by decade, follow directors, and join film clubs.",
      },
      { name: "author", content: "Retrowave" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400..800;1,400..700&family=Inter+Tight:wght@300..600&family=JetBrains+Mono:wght@400;500&display=swap",
      },
